          ...
          <div className="profile_img">
            <div className="container_img">
              ...
              <label htmlFor="_source_img" className='_source_img_label'>
                <img src={Camera} alt="" />
                <input type="file" name="" className='_source_img' accept='image/*' id="_source_img" />
              </label>
            </div>
          </div>
          <div className="my_profile">
            <h2 className="my_profile_title">
              Mening Profilim
            </h2>
            <form action="">
              <div>
              ...
              <div>
                ...
                <TextInput id={"phone"} type='tel' placeholder='+998 90 123 45 67' />
              </div>
              <div>

              </div>
            </form>
            <Button className='btn__save_profile'>
              Saqlash
            </Button>
          </div>
